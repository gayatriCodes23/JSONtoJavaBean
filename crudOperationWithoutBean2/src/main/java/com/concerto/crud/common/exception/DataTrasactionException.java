...
public class DataTrasactionException extends RuntimeException {

	private static final long serialVersionUID = 1L;

	public DataTrasactionException(String message) {
		super(message);
	}

	public DataTrasactionException(String message, Throwable cause) {
		super(message, cause);
	}
}